...
The base beta regression model identified several significant predictors of suicide rates, including HDI_year, GDP_capita, sex, age group, and generation. The extended beta regression model, which allows for varying precision based on HDI_year and GDP_capita, provided a slightly improved fit to understanding the relationship between these factors and suicide rates. While the overall trends remained consistent with the base model, the extended model offered greater flexibility and accuracy in predicting suicide rates across different levels of human development and economic prosperity. The non-linear relationship between HDI_year and predicted suicide rates, as visualized in the plot, further emphasizes the complex interplay of economic, social, and psychological factors influencing suicide risk.
